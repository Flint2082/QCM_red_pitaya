...
| `sweep_mode(oscillator_idx, settle_time=0.05)` | 20 kHz window at 100 Hz around the crystal's lock frequency |
...
**SWEEP fM** / **SWEEP fT** buttons in the UI: it centres a 20 kHz window,
stepped at 100 Hz, on the active crystal's mass or temp lock frequency.
